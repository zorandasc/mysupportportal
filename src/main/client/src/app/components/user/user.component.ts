...
export class UserComponent implements OnInit, OnDestroy {
  ...
  //read only displey clikc on row
  ...
  //dugme save changes u user add modalu
  ...
  //edit dugme u tabeli open edit modal
  ...
  //svae changes dugme u edit modalu
    ...
    this.subscriptions.push(
      this.userService.updateUser(formData).subscribe(
        (response: User) => {
          ...
          //update local user ali samo ako edituje sebe
          if (this.user.userId === response.userId) {
  ...
  //unutar user profila save changes
  public onUpdateCurrentUser(user: User): void {
    this.refreshing = true;
    this.currentUsername = this.userService.getUserFromLocalCache().username;
    const formData = this.userService.createUserFormData(
      this.currentUsername,
      user,
      this.profileImage
  ...
  //opwen window explorer
  public updateProfileImage(): void {
    this.clickButton('profile-image-input');
  }

  //sacuvaj izabranu sliku lokalno
  ...
  //mjeri progress unutar onUpdateProfileImage():
  ...
  private getUserRole(): string {
    return this.userService.getUserFromLocalCache().role;
  }
